"""
Django settings for major_pr project.
...
SECRET_KEY = 'django-insecure-84!f0$2^brlgk#vr)7s)2j&#k^^my*5i^4p2!_vpqyd7i=y212'
...
WSGI_APPLICATION = 'major_pr.wsgi.application'
